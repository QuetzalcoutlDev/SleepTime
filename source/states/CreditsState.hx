...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Credits'],
			['Quetzalcoutl',		'quetzal',		'Creator of Sleep Time',					 'https://twitter.com/ElQuetzalcoutl',		'D4D2D2'],
			['Kimihito',		'kimito',		'Voice Mixer',					 'https://youtube.com/@kimihito-od6yj?si=tPqn5bt9BcaY3WhB',		'604243'],
			[''],
			['Psych Engine Team'],
